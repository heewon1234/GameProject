					...
					<div id="body" class="container p-0">
						...
						<div id="bottom" class="p-3 mt-2">
							<div
								...
								<form class="d-flex" role="search" style="width: 80%; justify-content: flex-end;"
									action="/update.board">
							...
							<div class="mt-4" style="align-items: center;">
								<input class="form-control me-2" type="search" value="${contentsList.title}"
									aria-label="Search" style="width: 100%" name="title">
							</div>
							<div class="mt-4">
								<textarea id="summernote" name="contents" value="${contentsList.contents}"></textarea>
							</div>
						</div>
						</form>
