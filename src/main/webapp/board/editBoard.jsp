			...
			<div class="container-fluid p-0">
				...
				<div class="container-fluid p-0" style="background-color: #EEF1FF;">
					<div id="body" class="container p-0">
						...
						<form class="d-flex" role="search" action="/update.board" method="get"
							...
							<div id="bottom" class="p-3 mt-2 " style="width: 100%;">
								...
								<div class="mt-4" style="align-items: center;">
									<input value="${contentsList.seq}" aria-label="Search" style="display: none;"
										name="seq">
									<input class="form-control me-2" type="search" placeholder="제목을 입력해주세요."
										value="${contentsList.title}" aria-label="Search" style="width: 100%"
										name="title" id="board-title">
								</div>
								<div class="mt-4">
									<textarea id="summernote" name="contents">${contentsList.contents}</textarea>
								</div>
							</div>
						</form>
					</div>
