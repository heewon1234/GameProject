		...
		<div class="body">
			...
			<div class="game">
				...
				<div class="info">
					...
					<hr>
					<div class="game-info">
						- 바운스볼은 방향키를 조작해 공을 움직여 스테이지에 있는 별을 모두 얻는 게임입니다. <br> - 게임
						클리어 시간이 짧을수록 더 높은 랭킹에 위치하게 됩니다. <br> - 방향키 중 왼쪽 방향키 ( ⇦ ),
						아래쪽 방향키 ( ⇩ ), 오른쪽 방향키 ( ⇨ ) 를 사용해 조작합니다. <br> - 부스터 블럭 사용 시
						위쪽 방향키를 제외한 방향키를 누르면 공이 아래쪽으로 떨어지며 부스터 방향으로의 공의 진행을 멈출 수 있습니다.
					</div>
				</div>
			</div>
