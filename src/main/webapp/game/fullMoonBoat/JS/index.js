class Main extends Phaser.Scene {
  ...
  create() {
    ...
    let bottomBoundary = this.add.rectangle(
      0,
      this.cameras.main.height  - 10, // 이 부분을 조정하여 선을 원하는 위치에 그릴 수 있습니다.
    ...
    // 10라운드 시작
      ...
      if (!this.stage_10_stop) {
        ...
        if (this.frame % 30 == 0) {
          ...
          this.enemy_arr[this.enemy_arr_count - 2].setVelocityY(700);
          this.enemy_arr[this.enemy_arr_count - 2].setOrigin(0.5, 0.5);

          this.enemy_arr[this.enemy_arr_count - 1].setVelocityY(700);
          this.enemy_arr[this.enemy_arr_count - 1].setOrigin(0.5, 0.5);
        }
