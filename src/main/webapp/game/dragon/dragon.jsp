						...
						<ul class="nav nav-pills nav-fill"
							...
							<li class="nav-item dropdown"><button type="button" class="btn" data-bs-toggle="dropdown"
								...
								<ul class="dropdown-menu">
									...
									<li><a class="dropdown-item" href="/game/minesweeper/normalMinesweeper.jsp">중급</a>
									</li>
							...
							<li class="nav-item"><a class="nav-link" href="/game/dragon/dragon.jsp">드래곤 플라이트</a></li>
							<li class="nav-item"><a class="nav-link" href="/game/colorblind/colorblind.jsp">컬러블라인드</a>
							</li>
						</ul>
					</div>
