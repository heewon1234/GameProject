                ...
                <div class="row g-0">
                    ...
                    <div class="col-6 sign-body d-flex align-items-center">
                        <input type="text" class="form-control update_list" id="email1" name="email1"
                            style="width: 125px;">@
                        <input type="text" class="form-control" id="email2" name="email2" style="width: 125px;background-color: #D5D5D5;" readonly="true">
                    </div>
                </div>
                <div class="row g-0">
                    <div class="col-6"></div>
                    <div class="col-6 sign-body">
                        ...
                        <select class="form-select" id="email2_dropdown" style="width: 268px">
    ...
    <script>
        ...
        $("#email2_dropdown").on("change", function() {
            if($("#email2_dropdown option:selected").val() == "직접입력" ) {
                $("#email2").val("").css("backgroundColor", "white").attr("readonly", false);
            } else if($("#email2_dropdown option:selected").val() == "선택하세요") {
                $("#email2").val("").css("backgroundColor", "#D5D5D5").attr("readonly", true);
            } else {
                $("#email2").val($("#email2_dropdown option:selected").val()).css("backgroundColor", "#D5D5D5").attr("readonly", true);
            }
            let mailValue = inputEmail.value + "@" +inputEmail2.value;
            let emailRegExr = /^[A-Za-z0-9_].+@[A-Za-z0-9].+\.[a-z].+$/;
            if (mailValue == "") {
        ...
        frm.onsubmit = function () {
            ...
            if (!idRegExr.test(inputID.value)) {
                ...
                return false;
            } else if (!emailRegExr.test(inputEmail.value + "@" + inputEmail2.value)) {
