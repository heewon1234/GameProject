							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
								<c:choose>
									<c:when test="${loginID == null }">
										<li><a class="dropdown-item" href="/members/login.jsp">지뢰 찾기</a></li>
										<li><a class="dropdown-item" href="/members/login.jsp">바운스볼</a></li>
										<li><a class="dropdown-item" href="/members/login.jsp">플래피 버드</a></li>
										<li><a class="dropdown-item" href="/members/login.jsp">풀 문 보트</a></li>
										<li><a class="dropdown-item" href="/members/login.jsp">드래곤 플라이트</a></li>
										<li><a class="dropdown-item" href="/members/login.jsp">컬러 블라인드</a></li>
									</c:when>
									<c:otherwise>
										<li><a class="dropdown-item"
											href="/game/minesweeper/eazyMinesweeper.jsp">지뢰 찾기</a></li>
										<li><a class="dropdown-item"
											href="/game/bounceball/bounceball_main.jsp">바운스볼</a></li>
										<li><a class="dropdown-item"
											href="/game/flappyBird/flappyBird_main.jsp">플래피 버드</a></li>
										<li><a class="dropdown-item"
											href="/game/fullMoonBoat/JSP/fullMoonBoat.jsp">풀 문 보트</a></li>
										<li><a class="dropdown-item"
											href="/game/dragon/dragon.jsp">드래곤 플라이트</a></li>
										<li><a class="dropdown-item"
											href="/game/colorblind/colorblind.jsp">컬러 블라인드</a></li>
									</c:otherwise>
								</c:choose>
